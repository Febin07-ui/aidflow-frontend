        ...
        <section className='col-span-4'>
            ...
            <div className='bg-primary-blue h-screen p-6 '>
                ...
                <div className='flex justify-evenly items-center gap-5 mb-13 '>
                    ...
                    {/* Total Users*/}
                    <div className='bg-[#0B1220] flex flex-col w-80 h-35 p-4  rounded-lg border-1 border-gray-800'>
                        <div className='flex justify-between items-center gap-7 text-xl mb-2'>
                            <p className='text-gray-400 '>Total Users</p>
                            <FaUsers className='text-blue-500 text-xl'/> 
                        </div>
                        <p className='text-white text-3xl font-bold'>1100</p>
                    </div>
                    {/* Active Disasters  */}
                    <div className='bg-[#0B1220] flex flex-col w-80 h-35 p-4 w-60 h-25 rounded-lg border-1 border-gray-800'>
                        <div className='flex justify-between items-center gap-7 text-xl mb-2'>
                            <p className='text-gray-400 '>Active Disasters</p>
                    ...
                    <div className='bg-[#0B1220] flex flex-col w-80 h-35 p-4 rounded-lg border-1 border-gray-800'>
                        <div className='flex justify-between items-center gap-7 text-xl mb-2'>
                            <p className='text-gray-400 '>Resources Request</p>
