...
function SideBarItems() {
  ...
  return (
    <div className='flex flex-col pl-4 sticky top-0 z-1'>
        ...
        <div className='flex items-center gap-3 pl-3 mb-4 text-l cursor-pointer '>
            ...
            <p className='text-gray-400 font-semibold hover:text-blue-500'>Dashboard</p>
        </div>
        ...
        <div className='flex items-center gap-3 pl-3 mb-100 text-l cursor-pointer'>
            ...
            <p className='text-gray-400 font-semibold hover:text-blue-500 '>Profile</p>
        </div>
        {/* emergency box */}
